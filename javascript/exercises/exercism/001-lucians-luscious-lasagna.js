// Instructions
// Lucian's girlfriend is on her way home, and he hasn't cooked their
// anniversary dinner!
...
// Define the EXPECTED_MINUTES_IN_OVEN constant that represents how many
// minutes the lasagna should be in the oven. It must be exported.
// According to the cooking book, the expected oven time in minutes is 40.

const EXPECTED_MINUTES_IN_OVEN = 40

// 2. Calculate the remaining oven time in minutes
// Implement the remainingMinutesInOven function that takes the actual
// minutes the lasagna has been in the oven as a parameter and returns
// how many minutes the lasagna still has to remain in the oven, based
// on the expected oven time in minutes from the previous task.

function remainingMinutesInOven (actualMin) {
...
// Implement the preparationTimeInMinutes function that takes the
// number of layers you added to the lasagna as a parameter and
...
// the numberOfLayers parameter is the number of layers you added to the
// lasagna, and the actualMinutesInOven parameter is the number of minutes
